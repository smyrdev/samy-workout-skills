...
- Use `AskUserQuestion` for step 2 (the pre-filled re-confirm batch — offer "same as last time"
  as the first option) and for the veto/adjust loop in step 6. Free-text answers arrive through
