...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  test-onboarding-skill.sh   onboarding SKILL.md / references/rules.md policy regressions"
            echo "  test-onboarding-volume.sh  volume.py's command-line contract"
            echo "  test-generation-skill.sh   generation SKILL.md / references/rules.md / docs/generation-fields.md policy"
