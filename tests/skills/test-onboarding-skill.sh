...
#
# Schema validity, references/questions.yaml `stores:` resolution and volume.config.json
...
RULES="$REPO_ROOT/skills/onboarding/references/rules.md"
QUESTIONS="$REPO_ROOT/skills/onboarding/references/questions.yaml"
...
assert_file_contains "$SKILL" "references/questions.yaml" "points at references/questions.yaml"
assert_file_contains "$SKILL" "references/rules.md" "points at references/rules.md"
assert_file_contains "$SKILL" "assets/schema/profile.schema.json" "points at the profile schema"
...
echo "references/rules.md keeps the safety rules"
...
assert_file_contains "$RULES" "skills/onboarding/assets/examples/" "the shipped examples are off limits"
...
echo "references/questions.yaml keeps the profile/program scope split"
